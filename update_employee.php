<?php
	...
	if ($_SERVER["REQUEST_METHOD"]=="POST"){
		...
		$add=$_POST['employee_adrs'];
        $con=$_POST['employee_contact'];
            ...
            {
				echo 'ok';
		      	$sql="UPDATE `employee` SET `employee_name`='$name', `customer_adrs`='$add',`customer_contact`='$add', WHERE customer_id='$id'";
				$stid  = mysqli_query($conn, $sql);
